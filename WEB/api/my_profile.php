...
if (!empty($data["access_token"])) {
    ...
    $stmt = $conn->prepare("SELECT id_user, name, address, id_account FROM users WHERE access_token = ?");
    ...
    $stmt = $conn->prepare("SELECT email, phone, id_business, id_role FROM account WHERE id_account = ?");
